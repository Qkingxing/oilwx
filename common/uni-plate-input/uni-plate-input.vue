		...
		<view class="so-plate animation-scale-up">
			<view class="so-plate-head">
				<view class="so-plate-type">
					<radio-group @change="typeChange" class="flex justify-start">
						<label class="flex align-center">
							<radio class="blue" value="1" :checked="type===1" />
							<view class="inline-block margin-left-xs">普通车牌</view>
						</label>
						<label class="margin-left-xl blue flex align-center">
							<radio class="blue" value="2" :checked="type===2" />
							<view class="inline-block margin-left-xs">新能源车牌</view>
						</label>
					</radio-group>
				</view>
			</view>
			...
			<view class="so-plate-foot">
				...
				<view class="so-plate-keyboard"  style="height:235px">
					<view id="keyboard">
...
.so-plate-head  /deep/ wx-radio::before{
	font-size: 26upx;
	right: 8upx;
}
.so-plate-type label{
